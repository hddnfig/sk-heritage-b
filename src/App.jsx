...
const places = [
  { code: "S1", label: "SK 기념관", image: asset("place-memorial.png"), title: "두 거목의 정신을 기리는 곳, SK기념관", category: "경기도 용인시 처인구 원삼면", copy: "실제 선경직물 수원공장 관리동을 이전·복원한 추모관을 중심으로, 최종건 창업회장과 최종현 선대회장의 일대기와 유품, 경영철학을 통해 오늘의 SK를 만든 도전의 역사를 전합니다.", cta: "SK기념관 자세히보기" },
  { code: "S2", label: "SK 선혜원", image: asset("place-sunhye.png"), title: "시간이 머무는 집, 선혜원", category: "서울 종로구 선혜원", copy: "1968년, SK 창업주의 사저로 시작된 선혜원은 전통 한옥과 현대 건축, 예술이 어우러지는 새로운 문화 공간으로 이어지고 있습니다.", cta: "선혜원 자세히보기" },
  { code: "S3", label: "SK 고택", image: asset("place-gotaek.png"), title: "창업의 뿌리가\n살아있는 집\nSK고택", category: "경기도 수원시 권선구 평동", copy: "최종건 창업회장과 최종현 선대회장이 태어나 성장한 생가를 복원한 공간입니다. 1950~1960년대의 생활상과 두 경영인의 기업가정신을 담아 2024년 기념관으로 문을 열었습니다.", cta: "SK고택 자세히보기" },
];

const objects = [
  { mono: asset("object-loom-mono.png"), color: asset("object-loom-color.png"), title: "선경직물 직기", copy: "1960년대 선경직물 수원공장에서 원단을 생산하던 직기. 다시 시작한 역사의 상징입니다." },
  { mono: asset("object-rooster-mono.png"), color: asset("object-rooster-color.png"), title: "닭표 안감 ‘수탉 모형’", copy: "당시 선경직물의 대표 제품이었던 닭표 안감을 상징한 홍보 조형물입니다." },
  { mono: asset("object-jeep-mono.png"), color: asset("object-jeep-color.png"), title: "최종현 선대회장의 차량", copy: "산업 현장과 세계 곳곳을 누비며 도전의 길을 달렸던 최종현 선대회장의 차량입니다." },
];

const stories = [
  { image: asset("story-quiz.png"), title: "배움의 기회는\n더 넓어져야 한다", copy: "교육과 장학을 향한 꾸준한 관심은 방송과 다양한 사회공헌 활동으로 이어졌습니다." },
  { image: asset("story-loom-room.png"), title: "멈춰있던 기계가\n돌아가기 시작했다", copy: "1953년 전쟁으로 폐허가 된 수원공장. 잿더미 속에서 부품을 찾아 직조기계를 다시 움직였습니다." },
  { image: asset("story-ship.png"), title: "끝없이 이어지는 실처럼\n뻗어나가는 우리 직물", copy: "인도네시아 수출을 위해 원단을 선적하던 순간. 선경은 세계를 향한 발걸음을 넓혔습니다." },
  { image: asset("story-scholarship.png"), title: "수학보다 중요한 것은\n‘심기’", copy: "세계적인 인재 양성을 위한 장학 사업은 학문과 사람을 함께 키우는 SK의 믿음을 보여줍니다." },
];
  ...
  return (
    <main className="site-shell">
      ...
      <section id="top" className="hero">
        <img src={asset("hero.png")} alt="뉴욕 도심에 선 젊은 최종현 선대회장" />
      ...
      <section id="history" className="history-section history-new">
        ...
        <div className={`history-new-track step-${historyStep}`}>
          ...
          <article className="history-new-card history-new-1950"><RevealInline>1950</RevealInline><img src={asset("history-new-1950.png")} alt="1950년 선경직물 공장 정문" /></article>
          ...
          <article className="history-new-card history-new-1953"><RevealInline>1953</RevealInline><img src={asset("history-new-1953.png")} alt="1953년 공장 건물" /></article>
          <article className="history-new-card history-new-1966"><RevealInline>1966</RevealInline><img src={asset("history-new-1966.png")} alt="1966년 생산 현장" /></article>
          ...
          <article className="history-new-card history-new-1969"><RevealInline>1969</RevealInline><img src={asset("history-1969.png")} alt="1969년 선경합섬 공장" /></article>
          <article className="history-new-card history-new-1973"><RevealInline>1973</RevealInline><img src={asset("history-1973.png")} alt="1973년 MBC 장학퀴즈 첫 방송" /></article>
      ...
      <section className="legacy-banner"><img src={asset("legacy-new.png")} alt="SK 생산 현장을 둘러보는 선대회장" /><div className="legacy-overlay" /><div className="legacy-content"><RevealLines as="h2" lines={["SK의 역사와 창업회장, 선대회장의 정신을 되새겨 봅니다."]} /><RevealLines as="p" lines={["한국 경제의 두 거목 최종건 창업회장, 최종현 선대회장.", "불굴의 도전정신과 열정의 발자취를 따라가고,", "SK그룹의 역사와 경영철학의 계승, 발전을 다짐봅니다."]} /><a className="frost-button" href="#stories">추모 갤러리 <ArrowRight /></a></div></section>
